                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 order-details">
                            <h4 class="text-white">Shipment Details
                    ...
                    <tbody>
                        ...
                        <h4 class="px-2">Total price: <span class="float-end">{{$orders->total_price}}$(USD)</span></h4>
                        <h4 class="px-2">Pay mode: <span class="float-end">{{$orders->payment_mode}}</span></h4>
                        <div class="mt-5 px-2">
